#> mixedbag.iris:set_coordinates/pad_with_zeros
#
...
#
# @within mixedbag.iris:set_coordinates/main
# @input
#   value
#       A numeric value between 0 and 999999
# @writes
#   storage mixedbag.iris:data String
#       The resulting string

$data modify storage mixedbag.iris:data String set value "000000$(value)"
