execute unless predicate {"condition":"minecraft:entity_properties","entity":"this","predicate":{"slots":{"weapon.*":{"items":"#mixedbag:mortar/give_cobblestone"}}}} run return fail
loot spawn ~ ~0.5 ~ loot mixedbag:recipe/mortar/cobblestone_from_blocks
