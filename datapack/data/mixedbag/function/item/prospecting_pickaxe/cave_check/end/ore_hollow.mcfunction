title @s actionbar {translate:"subtitles.mixedbag.item.prospecting_pickaxe.ores_echo",color:"dark_gray",italic:1b}
playsound mixedbag:item.prospecting_pickaxe.ores player @a[distance=..16] ~ ~ ~ 1 0 0
playsound mixedbag:item.prospecting_pickaxe.echo block @a[distance=..16] ~ ~ ~ 2
