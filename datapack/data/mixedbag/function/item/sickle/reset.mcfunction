...
execute if score @s mixedbag.sickle.timer matches 20.. if entity @s[gamemode=!creative] run function mixedbag:item/sickle/damage
execute if score @s mixedbag.sickle.timer matches 20.. run function mixedbag:item/sickle/launch
